...
public class WinScreen implements Screen{
    ...
    public WinScreen(MainGame game, Skin theSkin){
        this.skin = theSkin;
        this.game = game;
        ...
        Label gameOver = new Label("You win", goStyle);
        Label gameOverMessage = new Label("T'as vaincu le grand Tengu. Félicitation Guigui la Melo", txtStyle);
